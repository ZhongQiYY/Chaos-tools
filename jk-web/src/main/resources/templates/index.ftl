...
<head>
    ...
    <title>JkAdmin Pro - 赣州建控投资控股集团</title>
    ...
    <link rel="stylesheet" href="${basePath}/dist/css/jk.min.css">
...
<div class="wrapper">
    <header class="main-header">
        ...
        <a href="javascript:void(0)" class="logo">
            <span class="logo-lg"><b>JkAdmin</b>Pro</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <div class="pull-right hidden-xs">
            <strong>Copyright &copy; ${year} <a href="http://www.xizinet.com/" class="company-info" target="_blank">赣州建控投资控股集团有限公司</a>.</strong> All rights reserved.版本号: <a>${version}</a>
        </div>
...
<!-- 封装 -->
<script type="text/javascript" src="${basePath}/dist/js/jk.min.js"></script>
<!-- 首页js -->
