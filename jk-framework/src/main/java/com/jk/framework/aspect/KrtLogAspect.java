package com.jk.framework.aspect;
...
public class KrtLogAspect {
     ...
     * 定义切入点
     */
    @Pointcut("@annotation(com.jk.common.annotation.KrtLog)")
