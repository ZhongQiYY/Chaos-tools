...
public class Sha1Utils {
    ...
    private final static int[] ABCDE = {
    ...
    private static byte[] byteArrayFormatData(byte[] bytedata)
    {
        ...
        long nn = (long) n * 8;
        byte h8 = (byte) (nn & 0xFF);
        byte h7 = (byte) ((nn >> 8) & 0xFF);
        byte h6 = (byte) ((nn >> 16) & 0xFF);
        byte h5 = (byte) ((nn >> 24) & 0xFF);
        byte h4 = (byte) ((nn >> 32) & 0xFF);
        byte h3 = (byte) ((nn >> 40) & 0xFF);
        byte h2 = (byte) ((nn >> 48) & 0xFF);
        byte h1 = (byte) (nn >> 56);
        newbyte[l++] = h1;
        newbyte[l++] = h2;
        newbyte[l++] = h3;
