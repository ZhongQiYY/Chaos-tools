            ...
            krt.ajax({
                ...
                success: function (rb) {
                    if (rb.code == 200) {
                        ...
                        $("#tree-table").remove();
                        var html = ' <table id="tree-table" class="table table-bordered table-hover table-jk"> <thead><tr><th>区域名称</th><th>区域编码</th> <th>类型</th><th>操作</th></tr></thead><tbody>' + tbody + '</tbody></table>';
